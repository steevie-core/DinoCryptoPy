...
RUNNING = [load_scaled_image(os.path.join("Assetsdino/Dino", "DinoRun1.png")),
           load_scaled_image(os.path.join("Assetsdino/Dino", "DinoRun2.png"))]
JUMPING = load_scaled_image(os.path.join("Assetsdino/Dino", "DinoJump.png"))
DUCKING = [load_scaled_image(os.path.join("Assetsdino/Dino", "DinoDuck1.png")),
           load_scaled_image(os.path.join("Assetsdino/Dino", "DinoDuck2.png"))]

SMALL_CACTUS = [load_scaled_image(os.path.join("Assetsdino/Cactus", f"SmallCactus{i + 1}.png")) for i in range(3)]
LARGE_CACTUS = [load_scaled_image(os.path.join("Assetsdino/Cactus", f"LargeCactus{i + 1}.png")) for i in range(3)]

BIRD = [load_scaled_image(os.path.join("Assetsdino/Bird", f"Bird{i + 1}.png")) for i in range(2)]

CLOUD = load_scaled_image(os.path.join("Assetsdino/Other", "Cloud.png"), 0.4)
BG = load_scaled_image(os.path.join("Assetsdino/Other", "Track.png"), 0.5)
...
def main():
    ...
    def score():
        ...
        if points >= 500:
            pygame.quit()
            subprocess.Popen(['chromium-browser', '--start-fullscreen', 'tsukasolutions.html'])
